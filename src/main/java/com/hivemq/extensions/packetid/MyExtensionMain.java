...
public class MyExtensionMain implements ExtensionMain {
    ...
    private void addPublishModifier() {
        ...
        final MyPublishInboundInterceptor myPublishInboundInterceptor = new MyPublishInboundInterceptor();

        initializerRegistry.setClientInitializer(
                (initializerInput, clientContext) -> clientContext.addPublishInboundInterceptor(myPublishInboundInterceptor));
    }
}