 ...
 */
class MyPublishInboundInterceptorTest {

    private @NotNull MyPublishInboundInterceptor myPublishInboundInterceptor;
    ...
    @BeforeEach
    void setUp() {
        myPublishInboundInterceptor = new MyPublishInboundInterceptor();
    ...
    void topicHelloWorld_payloadModified() {
        ...
        myPublishInboundInterceptor.onInboundPublish(publishInboundInput, publishInboundOutput);
